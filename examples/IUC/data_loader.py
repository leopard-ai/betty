...
class CocoDataset(data.Dataset):
    ...
    def __init__(self, args=None, root='./data/train2014', json='./data/annotations/captions_train2014.json'
                , vocab='./data/vocab.pkl', transform=None):
    ...
    def __getitem__(self, index):
        ...
        image = Image.open(os.path.join(self.root, path)).convert('RGB') # burnout in colab
...
def get_loader(root='./data/train', 
