...
class Network(nn.Module):
    ...
    """
    def __init__(self, C,  layers, criterion, decoder,steps=4, multiplier=4, stem_multiplier=3):
    ...
    def enc_params(self):
        return list(self.stem.parameters()) + list(self.cells.parameters()) + list(self.global_pooling.parameters()) + list(self.lin.parameters())
